...
public class LoginUsers {
      ...
      private enum Metric {
            OpenLoginPage("open-login-page"), Login("login");
      ...
      public static void main(String[] args) throws Exception {
            ...
            for (Map.Entry<Object, Object> user : usersProperties.entrySet()) {
                  ...
                  final String startUrl = System.getProperty("auth.server.address")
                              + "/api/login?redirect=http%3A%2F%2Flocalhost%3A8090%2Flink.html";
